...
{
    public partial class MenuCrmYonetimi : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void galleryControl1_Gallery_ItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            {
                BaglantiPotansiyel frm = new BaglantiPotansiyel();
                frm.MdiParent = Master.ActiveForm;
                frm.Show();
            }
            else if (value == 16)
            ...
            {
                SadakatYonetimi frm = new SadakatYonetimi();
                frm.MdiParent = Master.ActiveForm;
                frm.Show();
            }
            else if (value == 22)
